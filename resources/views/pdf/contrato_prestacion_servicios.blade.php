...
@section('body')
<div class="container">
	<div class="text-center"><strong>{{strtoupper( $tercero->nombre) }}<br>NIT: {{ $tercero->nit }}</strong></div><br>
	<div class="row">
			...
			<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
				<table WIDTH="95%" border="2">
					...
					<tr>
						...
						<td align="center"><strong> {{strtoupper($rubro->presupuesto->nrubro)}}</strong>
						</td>
					</tr>
					@else
					<tr align="center">
						...
						<td >
							<strong>{{strtoupper($rubro->presupuesto->nrubro)}}</strong>
						</td>
					</tr>
					@endif
					@endforeach
